...
// `enableSystem={false}` rather than the published source's `disableSystemTheme`,
// which is not a next-themes prop and fails the type check. This is the
// documented way to say the same thing.
