...
export function CarzBotChat() {
  ...
  useEffect(() => {
    ...
    const apply = () => {
      ...
      shell.style.height = `calc(100dvh - var(--nav-h) - var(--safe-top) - var(--back-h) - ${overlap}px)`;
  ...
  return (
    ...
    <div ref={shellRef} className="flex h-[calc(100dvh-var(--nav-h)-var(--safe-top)-var(--back-h))] flex-col">
      <div
        ref={threadRef}
